...
from atlas.api.abstract.model import SoftwarePackage, CustomSoftwareAction, PackageSuggestion, PackageUpdate, \
    PackageHistory, \
    SuggestionPriority, PackageStatus
from atlas.api.abstract.view import MessageType, MultipleSelectComponent, InputOption, SingleSelectComponent, \
...
from atlas.commons.system import ProcessHandler, get_dir_size, SimpleProcess
from atlas.commons.view_utils import get_human_size_str
from atlas.gems.web import INSTALLED_PATH, nativefier, DESKTOP_ENTRY_PATH_PATTERN, URL_FIX_PATTERN, ENV_PATH, \
    ROOT_DIR, TEMP_PATH, FIX_FILE_PATH, ELECTRON_CACHE_DIR, UA_CHROME, get_icon_path, URL_PROPS_PATTERN
from atlas.gems.web.config import WebConfigManager
from atlas.gems.web.environment import EnvironmentUpdater, EnvironmentComponent
from atlas.gems.web.model import WebApplication
from atlas.gems.web.search import SearchIndexManager
