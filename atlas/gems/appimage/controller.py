...
from atlas.api.abstract.controller import SoftwareManager, SearchResult, UpgradeRequirements, UpgradeRequirement, \
...
from atlas.api.abstract.model import SoftwarePackage, PackageHistory, PackageUpdate, PackageSuggestion, \
    SuggestionPriority, CustomSoftwareAction
from atlas.api.abstract.view import MessageType, FormComponent, InputOption, SingleSelectComponent, \
    SelectViewType, TextInputComponent, PanelComponent, FileChooserComponent, ViewObserver
from atlas.api.paths import DESKTOP_ENTRIES_DIR
from atlas.commons import resource
from atlas.commons.boot import CreateConfigFile
from atlas.commons.html import bold
from atlas.commons.system import SystemProcess, new_subprocess, ProcessHandler, SimpleProcess
from atlas.commons.version_util import normalize_version
from atlas.gems.appimage import query, INSTALLATION_DIR, APPIMAGE_SHARED_DIR, ROOT_DIR, \
...
from atlas.gems.appimage.config import AppImageConfigManager
from atlas.gems.appimage.model import AppImage
from atlas.gems.appimage.util import replace_desktop_entry_exec_command
from atlas.gems.appimage.worker import DatabaseUpdater, SymlinksVerifier, AppImageSuggestionsDownloader
