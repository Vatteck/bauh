...
from atlas.api.abstract.view import SingleSelectComponent, SelectViewType, InputOption, PanelComponent, \
    FormComponent, TextInputComponent
from atlas.api.exception import NoInternetException
from atlas.commons import suggestions
...
from atlas.commons.system import SystemProcess, ProcessHandler, new_root_subprocess
from atlas.commons.view_utils import new_select, get_human_size_str
from atlas.gems.snap import snap, URL_CATEGORIES_FILE, CATEGORIES_FILE_PATH, \
    get_icon_path, snapd
from atlas.gems.snap.config import SnapConfigManager
from atlas.gems.snap.model import SnapApplication
from atlas.gems.snap.snapd import SnapdClient
